	...
	<div class="mainConfig">
		<form id="configForm" onsubmit="return false;">
			...
			<div class="formInput">
				...
				<input id="carownerId" name="carownerId" type="text" class="validate[required] validate[custom[integer]]]">
			</div>
			<div class="formInput">
			...
			<div class="formInput">
				...
				<textarea id="DCChargeInfoUrl" name="DCChargeInfoUrl"  class="validate[custom[url]]"></textarea>
			</div>
		</form>
	</div>
