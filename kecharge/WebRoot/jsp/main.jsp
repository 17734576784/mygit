...
<html>
  ...
  <body class="bgColor">
	<div class="main">
		<div class="topHeader">
			<ul id="navbar">
				<li class="active"><a data="jsp/InterfaceTest.jsp">接口测试</a></li>
				<li><a  data="jsp/dataQuery.jsp">数据查询</a></li>
				<li><a  data="jsp/partnerConfig.jsp">档案配置</a></li>
				<li style="float: right"><a  data="">注销</a></li>
			</ul>
		</div>
