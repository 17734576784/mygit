...
public class MainTest {
	...
	public static void main(String[] args) throws Exception {
		...
		double num = ConverterUtil.toDouble("78.0");// 装换为double类型

		System.out.println((int) num);
		// byte[] tt = new byte[] {10, 12, 75, 69, 48, 48, 48, 48, 48, 48, 48,
		// 48, 54, 51, 16, 1, 26, 12, 48, 48, 56, 57,
		// 48, 48, 48, 48, 48, 48, 57, 48, 41, 118, 113, 27, 13, -17, -65, -67,
		// 45, -17, -65, -67, 63};
		// byte[] tt = new byte[] {10, 12, 75, 69, 48, 48, 48, 48, 48, 48, 48,
		// 48, 54, 51, 16, 1, 26, 10, 48, 48, 56, 57, 48, 48, 48, 48, 57,
		// 48, 41, 118, 113, 27, 13, -17, -65, -67, 45, -17, -65, -67, 63};
		// try {
		// TradeMsgOuterClass.TradeMsgChargeBegin_Inf i =
		// TradeMsgOuterClass.TradeMsgChargeBegin_Inf.parseFrom(tt);
		...
		// .map(substpara ->
		// getSubstpara(substpara)).collect(Collectors.toList());
		//
		...
		// long start = System.nanoTime();
		// List<JSONObject> count = list.stream().parallel().filter(substpara ->
		// substpara != null).map(substpara -> getSubstpara(substpara))
