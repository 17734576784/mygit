...
//			var html="<option value='-1'>全部<option>";
			...
			for(var k=0; k< jsonData.length;k++){
				html+="<option value='"+jsonData[k].partnerId+"'>"+jsonData[k].partnerName+"</option>"
			}
...
function initGrid() {
	...
	queryJsonStr.operatorId= $("#partnerId").val();
	...
	gridCommon.url = "/manage/listChargeMonitor.json"; // 请求地址
