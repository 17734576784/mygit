...
public class ComntDef {
	//字符长度预定义
		...
		public static final int YD_NETONLINETYPE_REALLINE3		= 2;	//实时在线(IP不固定/发心跳) 用于TCP客户端方式
		...
		public static final int EVCP_WEBMSGTYPE_APP_CHARGE_CAPITAL	= 72;	//发送充电指令-加盟商资金池
		...
		public static final String getErrCodeString(int errcode) {
			...
			case EVCP_TASKERR_CAROWNER:		ret_str = "车主信息错误";	break;
			case EVCP_TASKERR_PILEPARA:		ret_str = "充电桩参数错误";	break;
			case EVCP_TASKERR_GUNUSE:		ret_str = "充电枪占用";		break;
			case EVCP_TASKERR_WATERNO:		ret_str = "流水号错误";		break;		
