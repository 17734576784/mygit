/**   
* @Title: ComntFunc.java 
* @Package com.keicpms.communite 
* @Description: TODO(用一句话描述该文件做什么) 
* @author zhp
* @date 2018年12月13日 下午5:02:59 
* @version V1.0   
*/
...
public class ComntFunc {
    ...
    public static int string2Byte(String src_str, byte[] dest_str) {
    	if (dest_str == null || dest_str.length <= 0) return 0;
    	...
    	if (dest_str.length < tmp_bytes.length) dest_str[dest_str.length - 1] = 0;
    ...
    public static String printProtalData(byte[] prot_data) {
    	if (prot_data == null || prot_data.length <= 0) return "";
    	
    	StringBuffer str_buf = new StringBuffer(); 
    	
    	for (int i = 0; i < prot_data.length; i++) {
    		if (i > 0) str_buf.append(" ");
    ...
    public static void arrayCopy(byte[] dest_array, byte[] src_array, int copy_num) {
    	for (int i = 0; i < copy_num; i++) {
    		dest_array[i] = src_array[i];
    	}
    }
    
    public static void arrayCopy(byte[] dest_array, int dest_idx, byte[] src_array, int src_idx, int copy_num) {
    	for (int i = 0; i < copy_num; i++) {
    ...
    public static void arrayCopy(short[] dest_array, short[] src_array, int copy_num) {
    	for (int i = 0; i < copy_num; i++) {
    		dest_array[i] = src_array[i];
    	}
    }
    
    public static void arrayCopy(short[] dest_array, int dest_idx, short[] src_array, int src_idx, int copy_num) {
    	for (int i = 0; i < copy_num; i++) {
    		dest_array[dest_idx + i] = src_array[src_idx + i];
    	}
    }
    ...
    public static void arrayCopy(int[] dest_array, int dest_idx, int[] src_array, int src_idx, int copy_num) {
    	for (int i = 0; i < copy_num; i++) {
    		dest_array[dest_idx + i] = src_array[src_idx + i];
    	}
    }
    ...
    public static void arrayCopy(float[] dest_array, float[] src_array, int copy_num) {
    	for (int i = 0; i < copy_num; i++) {
    		dest_array[i] = src_array[i];
    	}
    }
    
    public static void arrayCopy(float[] dest_array, int dest_idx, float[] src_array, int src_idx, int copy_num) {
    	for (int i = 0; i < copy_num; i++) {
    		dest_array[dest_idx + i] = src_array[src_idx + i];
    	}
    }
    ...
    public static void arrayCopy(double[] dest_array, double[] src_array, int copy_num) {
    	for (int i = 0; i < copy_num; i++) {
    		dest_array[i] = src_array[i];
    	}
    }
    
    public static void arrayCopy(double[] dest_array, int dest_idx, double[] src_array, int src_idx, int copy_num) {
    	for (int i = 0; i < copy_num; i++) {
    		dest_array[dest_idx + i] = src_array[src_idx + i];
    	}
    }
    ...
    public static void arraySet(byte[] array, int idx, int len, byte val) {
    	for (int i = idx; i < len; i++) array[i] = val;
    }
