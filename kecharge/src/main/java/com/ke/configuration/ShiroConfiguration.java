...
//	    filterChainDefinitionMap.put("/doadd.html"," perms[perm1,perm2]");
//	    filterChainDefinitionMap.put("/doget.html"," perms[admin]");
//	    filterChainDefinitionMap.put("/doupdate.html"," perms[perm1]");
//	    filterChainDefinitionMap.put("/dodel.html"," perms[perm2]");
//	    filterChainDefinitionMap.put("/logout.html","user");
	       //对所有用户认证
