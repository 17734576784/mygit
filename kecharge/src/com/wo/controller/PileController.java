...
public class PileController {
	...
	@RequestMapping("/listPileInfo")
	public String listPileState(String queryJsonStr) {
		JSONObject rtnJson = new JSONObject();
		rtnJson = this.pileService.listPileInfo(queryJsonStr);
		return CommFunc.Josn2Str(rtnJson);
	}
	
	@RequestMapping("/listGunInfo")
	public String listGunInfo(String queryJsonStr) {
		JSONObject rtnJson = new JSONObject();
		rtnJson = this.pileService.listGunInfo(queryJsonStr);
		return CommFunc.Josn2Str(rtnJson);
	}
	
	@RequestMapping("/listGunState")
	public String listGunState(String queryJsonStr) {
		JSONObject rtnJson = new JSONObject();
		rtnJson = this.pileService.listGunState(queryJsonStr);
		return CommFunc.Josn2Str(rtnJson);
	}
