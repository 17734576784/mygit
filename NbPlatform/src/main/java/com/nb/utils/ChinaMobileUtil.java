...
public class ChinaMobileUtil {
	...
	public static boolean checkToken(String msg, String nonce, String signature, String token)
		...
		LoggerUtils.Logger(LogName.INFO).info("url&token validation: result {},  detail receive:{} calculate:{}",
	...
	public static boolean checkSignature(BodyObj obj, String token) {
		...
		LoggerUtils.Logger(LogName.INFO).info("check signature: result:{}  receive sig:{},calculate sig: {}",
