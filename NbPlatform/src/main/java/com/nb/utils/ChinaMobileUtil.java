...
public class ChinaMobileUtil {
	  private static MessageDigest mdInst;
	    ...
	    public static boolean checkToken(String msg,String nonce,String signature, String token) throws UnsupportedEncodingException {
	        ...
	        LoggerUtils.Logger(LogName.INFO).info("url&token validation: result {},  detail receive:{} calculate:{}", sig.equals(signature.replace(' ','+')),signature,sig);
	    ...
	    public static boolean checkSignature(BodyObj obj, String token)  {
	        ...
	        LoggerUtils.Logger(LogName.INFO).info("check signature: result:{}  receive sig:{},calculate sig: {}",calSig.equals(obj.getMsgSignature()),obj.getMsgSignature(),calSig);
