...
/** 
* @ClassName: ChinaUnicomCommandUpdataService 
...
*/
@Component
public class ChinaUnicomCommandUpdataService implements ICommandService {
...
//				System.out.println(LocalDateTime.now() + "  下发 : " + receivedPackNum );
				...
				String command = ChinaUnicomUpGradeUtil.getCommandParam(deviceId, fileKey, packNum, (short)receivedPackNum, upgradeFile);
