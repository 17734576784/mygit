...
public class Log4jUtils {
	 ...
	 private static final Logger minaServer = Logger.getLogger("minaServer");
	...
	public Log4jUtils() {
		...
		String filePath = realBasepath + "\\classes\\log4j.properties";
	...
	/**
	 * @return the minaserver
	 */
	public static Logger getMinaserver() {
		return minaServer;
	}
