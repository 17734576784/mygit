...
public class ChargeInfo implements Serializable {
	...
	/**
	 * @param orderSerialNumber the orderSerialNumber to set
	 */
	...
	/**
	 * @param pileCode the pileCode to set
	 */
	...
	/**
	 * @param pileId the pileId to set
	 */
	...
	/**
	 * @param prepaidMoney the prepaidMoney to set
	 */
	...
	/**
	 * @param prechargeGive the prechargeGive to set
	 */
	...
	/**
	 * @param prechargePrincipal the prechargePrincipal to set
	 */
	...
	*/
	...
	public String toString() {
		return "ChargeInfo [memberId=" + memberId + ", pileCode=" + pileCode + ", pileId=" + pileId + ", gunId=" + gunId
				...
				+ chargeMoney + ", chargeAmount=" + chargeAmount + ", endCause=" + endCause + ", appFlag=" + appFlag
				+ ", prepayType=" + prepayType + ", operatorId=" + operatorId + ", couponId=" + couponId
				+ ", prepaidMoney=" + prepaidMoney + ", prechargeGive=" + prechargeGive + ", prechargePrincipal="
				+ prechargePrincipal + ", payRatio=" + payRatio + ", rechargeMoney=" + rechargeMoney + ", payableMoney="
				+ payableMoney + ", discountMoney=" + discountMoney + ", paymentMoney=" + paymentMoney + "]";
	}
}
